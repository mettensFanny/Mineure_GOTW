export default class Dude {
    constructor(dudeMesh, id, speed, scaling, scene) {
        ...
        const points = []; // chemin de ronde
        points.push(new BABYLON.Vector3(100, 0, 100));
        points.push(new BABYLON.Vector3(100, 0, -100));
        points.push(new BABYLON.Vector3(-100, 0, -100));
        //points.push(new BABYLON.Vector3(-100, 0, 100));
        this.points = points;

        let etape = 0;// etape du chemin en cours
        this.etape = etape;

    }

    move(scene) {
        //https://playground.babylonjs.com/#N9IZ8M#1 aide pour faire le chemin de ronde
        ...
        let direction = this.points[this.etape].subtract(this.dudeMesh.position);
        ...
        //// Modifier I Quand le pts est atteint
        ...
        if (distance > 30) {
            ...
            //a.pause();
            this.etape = (this.etape+1)%this.points.length;
