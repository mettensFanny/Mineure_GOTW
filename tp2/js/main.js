...
function createGround(scene) {
    ...
    function onGroundCreated() {
        ...
        groundMaterial.diffuseTexture = new BABYLON.Texture("images/grd.jpg");

        groundMaterial.bumpTexture = new BABYLON.Texture("images/gns_bump.jpg");

        groundMaterial.diffuseTexture.uScale =40.0;
        groundMaterial.diffuseTexture.vScale = 40.0;
        groundMaterial.bumpTexture.uScale = 40.0;
        groundMaterial.bumpTexture.vScale = 40.0;
...
function createTank(scene) {
    ...
    //let tank = new BABYLON.SceneLoader.ImportMesh("heroTank","models/","ufo.glb",scene);
